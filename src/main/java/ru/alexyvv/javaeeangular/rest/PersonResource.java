package ru.alexyvv.javaeeangular.rest;

import ru.alexyvv.javaeeangular.data.Person;
import ru.alexyvv.javaeeangular.pagination.PaginatedListWrapper;
...
/**
 * REST Service для работы с данными пользователя.
 */
@Stateless
